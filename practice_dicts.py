# # Practice exercises from EdX course 6.00.1.x

# grades = {'Anna':'B', 'John':'A', 'Matt':'C', 'Dave':'C'}
# print(grades['Anna'])
...
print(f"""Fibonacci series in an efficient way {fib_efficient(number_to_use, d)}
and number of times the function was called {numofCalls}""")